...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FancyBoxPlugin'
        db.create_table('cmsplugin_fancyboxplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('link_text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('link_image', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='fancyboxplugin_set_link_image', null=True, blank=True, to=orm['filer.Image'])),
            ('link_image_height', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('link_image_width', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('target_image', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fancyboxplugin_set_target_image', null=True, to=orm['filer.Image'])),
            ('target_image_height', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('target_image_width', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('popup_text', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal('cmsplugin_fancybox', ['FancyBoxPlugin'])


    def backwards(self, orm):
        
        # Deleting model 'FancyBoxPlugin'
        db.delete_table('cmsplugin_fancyboxplugin')
