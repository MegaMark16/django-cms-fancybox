...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FancyBoxPlugin.link_image_alignment'
        db.add_column('cmsplugin_fancyboxplugin', 'link_image_alignment', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FancyBoxPlugin.link_image_alignment'
        db.delete_column('cmsplugin_fancyboxplugin', 'link_image_alignment')
    ...
    models = {
        ...
        'cmsplugin_fancybox.fancyboxplugin': {
            ...
            'link_image_alignment': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
